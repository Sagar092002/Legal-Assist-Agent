...
//                     onClick={handleClick}
//                   >
//                     <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-white hover:shadow-xl transition-shadow duration-300">
...
//                         <button className="mt-4 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-300 font-semibold">
//                           View Document
//                         </button>
//                       </div>
//                     </div>
