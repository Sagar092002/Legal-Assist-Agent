...
// /**
//  * Reimagined Home component that transforms the UI to match the provided
//  * DocBuddy-style design while keeping ALL original functionality intact:
//  *  - Context resets (setStep1..4)
//  *  - Fetching services from backend
//  *  - Routing to /service/:id
//  *  - Navbar, Chatbot and Footer components preserved and used as before
//  *
//  * This file uses Tailwind classes for layout and responsiveness.
//  * Make sure your Tailwind config + fonts (Inter / DM Serif) are loaded globally.
//  */
...
//     // preserve original behavior: reset steps
...
//     // fetch services (same endpoint as original)
//     setLoading(true);
//     fetch("http://127.0.0.1:5000/api/services")
//       .then((res) => {
...
//       {/* Navbar (keeps your existing Navbar implementation & props) */}
//       <Navbar />
...
//                   className="block p-4"
//                 >
//                   <div className="h-full bg-white rounded-2xl shadow-sm hover:shadow-md transition-transform transform hover:-translate-y-1 border border-gray-100 overflow-hidden">
//                     {/* image area */}
//                     <div className="w-full h-48 flex items-center justify-center bg-white/60 overflow-hidden">
//                       <img
//                         src={service.img_link}
...
//       {/* Chatbot (exactly preserved - same component used) */}
//       <div className="max-w-6xl mx-auto px-6 mt-12">
//         <div className="flex justify-end">
//           {/* keep Chatbot component exactly as in your project */}
//           {/* <Chatbot /> */}
//         </div>
//       </div>
//     </div>
...
// /**
//  * Home component with upgraded card UI and smooth hover transitions.
//  */
// function Home() {
//   const context = useContext(StepContext);
//   const [data, setData] = useState([]);
...
//           <h1 className="mt-10 text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight" style={{ fontFamily: "'DM Serif Display', serif" }}>
//             Tired of making legal documents?
//           </h1>
//           <p className="mt-4 text-base sm:text-lg text-[#374151]">
//             This is your one stop destination to get all your queries resolved!
//           </p>
//           <p className="mt-6 text-sm sm:text-base md:text-lg text-[#4B5563] max-w-3xl mx-auto leading-relaxed">
//             Now seamlessly draft your legal documents without knowing any legal jargons. Just answer some easy questions and get your documents drafted with custom editable feature.
//             <br />
//             Not sure which document to choose? Ask our AI powered chatbot!
//           </p>
//         </div>
...
//       <section className="mt-1">
//         <div className="max-w-6xl mx-auto px-6">
//           <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8" style={{ fontFamily: "'DM Serif Display', serif" }}>
//             Available Documents
//           </h2>
...
//           ) : data.length === 0 ? (
//             <div className="flex items-center justify-center py-20">
//               <p className="text-xl text-[#374151] font-medium">No documents available.</p>
//             </div>
//           ) : (
//             <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
//               {data.map((service) => (
//                 <Link key={service.service_id} to={`/service/${service.service_id}`} className="block p-2">
...
//                     {/* content */}
//                     <div className="p-6 bg-white">
//                       <h3 className="text-lg font-semibold text-[#111827] text-center">{service.service_name}</h3>
//                       <p className="mt-3 text-sm text-[#4B5563] leading-relaxed text-justify max-h-28 overflow-hidden">
//                         {service.description}
//                       </p>
//                     </div>
